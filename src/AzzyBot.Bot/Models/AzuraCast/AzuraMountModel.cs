...
public sealed record class AzuraStationMountModel : AzuraDefaultMountBaseModel
{
    /// <summary>
...
/// </summary>
public sealed record class AzuraHlsMountModel : AzuraDefaultMountBaseModel
{
    /// <summary>
    ...
    public required AzuraMountLinksBaseModel Links { get; init; }
}

/// <summary>
/// Represents a mount point on an AzuraCast station.
/// </summary>
public sealed record class AzuraMountModel : AzuraMountBaseModel
{
    /// <summary>
    ...
    /// </summary>
    [JsonPropertyName("links")]
    public required AzuraMountLinksModel Links { get; init; }
}

/// <summary>
/// Represents a link section of a mount point on an AzuraCast station.
/// </summary>
public record class AzuraMountLinksModel : AzuraMountLinksBaseModel
{
    /// <summary>
...
/// </summary>
public record class AzuraMountLinksBaseModel
{
    /// <summary>
...
/// </summary>
public record class AzuraDefaultMountBaseModel : AzuraMountBaseModel
{
    /// <summary>
    /// Bitrate (kbps) of the broadcasted audio (if known)
    /// </summary>
...
/// Represents a base record for a mount point.
/// </summary>
public record class AzuraMountBaseModel
{
    /// <summary>
