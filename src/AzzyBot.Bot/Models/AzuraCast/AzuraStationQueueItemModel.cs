...
/// </summary>
public record class AzuraStationQueueItemModel
{
    /// <summary>
    ...
    public required AzuraSongDataModel Song { get; init; }
}

/// <summary>
/// Represents a detailed queue item from AzuraCast.
/// </summary>
public sealed record class AzuraStationQueueItemDetailedModel : AzuraStationQueueItemModel
{
    /// <summary>
