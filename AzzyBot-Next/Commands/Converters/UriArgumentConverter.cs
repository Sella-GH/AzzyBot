...
public sealed class UriArgumentConverter : ISlashArgumentConverter<Uri>
{
    ...
    public Task<Optional<Uri>> ConvertAsync(InteractionConverterContext context, InteractionCreatedEventArgs eventArgs) => ConvertAsync(context?.Argument?.RawValue);
