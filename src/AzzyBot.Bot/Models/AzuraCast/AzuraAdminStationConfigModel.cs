...
/// </summary>
public sealed record class AzuraAdminStationConfigModel
{
    /// <summary>
    /// Station ID
    /// </summary>
    ...
    public required AzuraAdminStationConfigBackendModel BackendConfig { get; set; }
...
/// </summary>
public sealed record class AzuraAdminStationConfigBackendModel
{
    /// <summary>
