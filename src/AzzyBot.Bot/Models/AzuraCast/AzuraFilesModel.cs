...
/// </summary>
public record class AzuraFilesModel
{
    /// <summary>
...
public sealed record class AzuraFilesDetailedModel : AzuraFilesModel
{
    ...
    public required IReadOnlyList<AzuraFilesPlaylistModel> Playlists { get; init; }
...
/// </summary>
public sealed record class AzuraFilesPlaylistModel
{
    /// <summary>
    /// The playlist ID
    /// </summary>
...
/// </summary>
public sealed record class AzuraFileUploadModel
{
    /// <summary>
    /// The relative path of the media file.
    /// </summary>
    ...
    public AzuraFileUploadModel(string path, string file)
    {
        Path = path;
        File = file;
    }
...
/// </summary>
public sealed record class AzuraFileComplianceModel
{
    /// <summary>
    ...
    public AzuraFileComplianceModel(bool isCompliant, bool titleCompliance, bool performerCompliance)
    {
