...
internal static class ServiceRegistering
{
    ...
    internal static void AzzyBotServices(this IServiceCollection services)
    {
        ...
        services.AddDbContext<DatabaseContext>(options => options.UseMySql(connectionString, ServerVersion.AutoDetect(connectionString), x => x.MigrationsAssembly("AzzyBot-Next.Migrations")));
