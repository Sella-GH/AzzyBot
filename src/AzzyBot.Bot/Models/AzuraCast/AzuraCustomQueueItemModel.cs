...
/// </summary>
public sealed record class AzuraCustomQueueItemModel
{
    /// <summary>
    ...
    public AzuraCustomQueueItemModel(ulong guildId, Uri uri, int stationId, string requestId, string songId, DateTimeOffset timestamp)
    {
        GuildId = guildId;
        BaseUri = uri;
        StationId = stationId;
