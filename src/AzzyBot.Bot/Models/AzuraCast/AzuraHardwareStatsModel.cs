...
/// </summary>
public sealed record class AzuraHardwareStatsModel
{
    /// <summary>
...
/// </summary>
public sealed record class AzuraCpuData
{
    /// <summary>
...
/// </summary>
public record class AzuraCpuTotalData
{
    /// <summary>
...
public sealed record class AzuraCoreData : AzuraCpuTotalData;

/// <summary>
/// Represents the memory data for an AzuraCast instance.
/// </summary>
public sealed record class AzuraMemoryData : AzuraDiskData
{
    /// <summary>
...
/// </summary>
public record class AzuraDiskData
{
    /// <summary>
...
/// </summary>
public sealed record class AzuraNetworkData
{
    /// <summary>
...
/// </summary>
public sealed record class AzuraTransmissionData
{
    /// <summary>
